            ...
            <ul>
              <li style={lineItems}>
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="http://www.gaurimhaiskar.com/"
                >
                  <FontAwesomeIcon icon={faGlobe} style={icons} />
                </a>
              </li>
              <li style={lineItems}>
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://www.linkedin.com/in/gauri-mhaiskar-08688160/"
                >
              ...
              <li style={lineItems}>
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://github.com/Ann-pixel"
                >
                  <FontAwesomeIcon icon={faGithub} style={icons} />
                </a>
              </li>
            </ul>
          </Col>
            ...
            <ul>
              <li style={lineItems}>
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="http://www.linkedin.com/in/alison-lee-4547b114"
                >
                  <FontAwesomeIcon icon={faLinkedin} style={icons} />
                </a>
              </li>
              <li style={lineItems}>
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://github.com/alison2686"
                >
                  <FontAwesomeIcon icon={faGithub} style={icons} />
                </a>
              </li>
            ...
            <ul>
              <li style={lineItems}>
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://www.linkedin.com/in/tracyreuther/"
                >
                  <FontAwesomeIcon icon={faLinkedin} style={icons} />
                </a>
              </li>
              <li style={lineItems}>
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://github.com/tracy-tucker"
                >
                  <FontAwesomeIcon icon={faGithub} style={icons} />
                </a>
              </li>
            ...
            <ul>
              <li style={lineItems}>
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://github.com/hhanschu"
                >
                  <FontAwesomeIcon icon={faGithub} style={icons} />
                </a>
              </li>
